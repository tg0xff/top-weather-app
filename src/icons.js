class Icons {
  ...
  static conditionToIcon = {
    "Blowing Or Drifting Snow": cloudSnowIcon,
    "Heavy Freezing Drizzle/Freezing Rain": cloudRainIcon,
    "Light Freezing Drizzle/Freezing Rain": cloudDrizzleIcon,
    "Freezing Fog": cloudFogIcon,
    "Heavy Freezing Rain": cloudRainHeavyIcon,
    "Light Freezing Rain": cloudRainIcon,
    "Funnel Cloud/Tornado": tornadoIcon,
    "Hail Showers": cloudHailIcon,
    Ice: snowIcon,
    "Lightning Without Thunder": lightningIcon,
    Mist: cloudFogIcon,
    Drizzle: cloudDrizzleIcon,
    "Precipitation In Vicinity": cloudsIcon,
    Rain: cloudRainIcon,
    "Heavy Rain And Snow": cloudSnowIcon,
    "Light Rain And Snow": cloudSnowIcon,
    "Rain Showers": cloudDrizzleIcon,
    "Heavy Rain": cloudRainHeavyIcon,
    "Light Rain": cloudDrizzleIcon,
    "Sky Coverage Decreasing": cloudSunIcon,
    "Sky Coverage Increasing": cloudsIcon,
    "Sky Unchanged": cloudSunIcon,
    "Heavy Drizzle": cloudRainIcon,
    "Smoke Or Haze": cloudHazeIcon,
    Snow: snowIcon,
    "Snow And Rain Showers": cloudSnowIcon,
    "Snow Showers": cloudSnowIcon,
    "Heavy Snow": cloudSnowIcon,
    "Light Snow": cloudSnowIcon,
    Squalls: windIcon,
    Thunderstorm: cloudLightningRainIcon,
    "Thunderstorm Without Precipitation": cloudLightningIcon,
    "Diamond Dust": cloudSunIcon,
    "Light Drizzle": cloudDrizzleIcon,
    Hail: cloudHailIcon,
    Overcast: cloudsIcon,
    "Partially cloudy": cloudSunIcon,
    Clear: sunIcon,
    "Heavy Drizzle/Rain": cloudRainIcon,
    "Light Drizzle/Rain": cloudRainIcon,
    "Dust storm": windIcon,
    Fog: cloudFogIcon,
    "Freezing Drizzle/Freezing Rain": cloudRainIcon,
  };
}
